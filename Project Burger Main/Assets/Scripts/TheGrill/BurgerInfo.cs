...
public class BurgerInfo : MonoBehaviour {
    ...
    public BurgerQualityVariables MyVariablesUp = new BurgerQualityVariables(0,0,0);
    public BurgerQualityVariables MyVariablesDown = new BurgerQualityVariables(0,0,0);
...
public struct BurgerQualityVariables {
    ...
    public BurgerQualityVariables(float a, float b, int c) {
        _BurgerTime = a;
        _BurgerHeat = b;
        _BurgerState = c;
    }
